...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, SKPhotoBrowserDelegate {
    ...
    override func viewDidLoad() {
        ...
        for i in 0..<10 {
            ...
            if i == 2 {
                photo.photoURL = "https://images.unsplash.com/photo-1458324124043-7803d4fec380?crop=entropy&dpr=2&fit=crop&fm=jpg&h=800&ixjsv=2.1.0&ixlib=rb-0.3.5&q=50&w=1275"
            }
